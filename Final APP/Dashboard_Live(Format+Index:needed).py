        ...
        while True:
            ...
            with st.container():
                ...
                with col1:  # Left Column
                    st.plotly_chart(st.session_state.fig1, config={"responsive": True}, use_container_width=True,key=f"fig1_chart_{uniq_id}")
                
                with col2:  # Right Column
                    st.plotly_chart(st.session_state.fig4, config={"responsive": True}, use_container_width=True,key=f"fig4_chart_{uniq_id}")
            ...
            with st.container():
                ...
                with col3:  # Left Column
                    st.plotly_chart(st.session_state.fig2, config={"responsive": True}, use_container_width=True,key=f"fig2_chart_{uniq_id}")
                
                with col4:  # Right Column
                    st.plotly_chart(st.session_state.fig5, config={"responsive": True}, use_container_width=True,key=f"fig5_chart_{uniq_id}")
