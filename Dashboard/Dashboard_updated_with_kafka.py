    ...
    try:
        ...
        while True:
            ...
            if raw_msg is not None and not raw_msg.error():
                ...
                raw_data_placeholder.dataframe(pd.DataFrame([message_value]))  # Display as DataFrame
            ...
            if compile_msg is not None and not compile_msg.error():
                ...
                compile_duration_placeholder.dataframe(pd.DataFrame([message_value]))  # Display as DataFrame
            ...
            if query_msg is not None and not query_msg.error():
                ...
                query_counter_placeholder.dataframe(pd.DataFrame([message_value]))  # Display as DataFrame
            ...
            # Force the page to refresh every 3 seconds to get new data
            time.sleep(3)
